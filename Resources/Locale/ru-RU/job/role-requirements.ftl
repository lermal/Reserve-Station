...
role-timer-role-insufficient = Требуется ещё [color=yellow]{ $time }[/color] минут игры в качестве [color={ $departmentColor }]{ $job }[/color] для этой опции.
role-timer-role-too-high = Требуется на [color=yellow]{ $time }[/color] меньше минут игры в качестве [color={ $departmentColor }]{ $job }[/color] для этой опции. (Вы пытаетесь играть за роль для новичков?)
