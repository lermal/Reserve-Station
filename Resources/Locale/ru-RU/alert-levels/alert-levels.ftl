...
alert-level-omicron-announcement = Активирован режим переопределения станции. Ожидайте дальнейших указаний от Центрального Командования, оставайтесь в своих отделах.
...
alert-level-amber-announcement = На станции зафиксирована непосредственная угроза уничтожения. Всем членам экипажа предписано вооружиться любыми доступными средствами. Экипаж всех отделов обязан оказать помощь службе безопасности и главам отделов в обороне станции.
alert-level-amber-instructions = Членам экипажа предписано вооружиться для защиты станции от угрозы уничтожения.
