...
guide-entry-burger-recipes = Бургеры
guide-entry-fastfood-recipes = Фастфуд
guide-entry-savory-recipes = Солёно-пряные
guide-entry-bread-recipes = Хлебобулочные
guide-entry-breakfast-recipes = Завтраки
guide-entry-moth-recipes = Еда для нианов
guide-entry-pasta-recipes = Паста & Лапша
guide-entry-dessert-recipes = Выпечка & Десерты
guide-entry-soup-recipes = Супы & Рагу
guide-entry-pie-recipes = Пироги & Тарты
