...
ent-ClothingHeadHatBeretCommand = командный берет
    .desc = Берет с логотипом NanoTrasen. Он излучает авторитет.
...
ent-ClothingHeadHatWitch1 = { ent-ClothingHeadHatWitch }
    .desc = { ent-ClothingHeadHatWitch.desc }
...
ent-ClothingHeadHatCanadaBeanie = шапка
    .desc = Красная, белая и уютная. Она излучает домашнюю атмосферу, особенно если у вас дома прохладно и много кафешек.
...
ent-ClothingHeadHatTacticalMaidHeadband = тактическая головная повязка уборщика
...
ent-ClothingHeadHatSolidHeadband = головная повязка солида
    .desc = Надевая это, вы будете чувствовать себя невидимкой! (ОГОВОРКА: НА САМОМ ДЕЛЕ ЭТО НЕ ДЕЛАЕТ ВЛАДЕЛЬЦА НЕВИДИМЫМ)
