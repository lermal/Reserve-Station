...
ent-PlushieLizardInversed = плюшевый дракончик
    .desc = Очаровательная мягкая игрушка, напоминающая ящерицу из инверсионного измерения. Хью!
...
ent-PlushieExperiment = плюшевый эксперимент
    .desc = Мягкая игрушка некоего собачьего происхождения, которая жаждет подорваться на минном поле.
