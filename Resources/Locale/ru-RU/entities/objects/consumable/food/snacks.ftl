...
ent-FoodSnackMREBrownieOpen = брауни
    ...
    .suffix = ИРП
ent-FoodSnackSwirlLollipop = радужный мега-леденец
    .desc = Вкусный завитой кружок концентрированного сахара. Кто теперь самый большой ребенок на школьной площадке?
